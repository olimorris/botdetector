...
from botdetector.counter import Counter
from botdetector.formatter import Formatter
from botdetector.search import Search
from botdetector.tree import Tree
...
def version_callback(value: bool):
    if value:
        typer.echo(f"Bot Detector Version: {__version__}")
        raise typer.Exit()
...
def main(
    ...
    if not bot:
        ...
        print("See 'botdetector --help' for more information.")
